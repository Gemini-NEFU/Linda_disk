...
<head>
    ...
    <script>
        ...
        function partsort(filePath){
            var encodePath=encodeURI(filePath);
            window.location.href="MR_PartSortServlet?filePath="+encodePath;
        }
...
<div class="frame-center">
    ...
    <div class="frame-title">
        	   <span>
	        	    <a href="HdfsServlet?flag=manage"> 全部文件  | MR-分区排序</a>
            ...
            <table id="center_table">
                <c:forEach var="f" items="${hdfsFileList}">
                    <tr>
                        ...
                        <td >
                            <div>
                                <a href="javascript:partsort('${f.path }')"><img src="images/a.png" title="分区排序"  />分区排序</a>
                            </div>
                        </td>
                        <td>${f.len}</td>
