...
<head>
    ...
    <script>
        ...
        function sort(filePath){
            ...
            window.location.href="MR_LogServlet?filePath="+encodePath;
        }
...
<div class="frame-center">
    ...
    <div class="frame-title">
        	   <span>
	        	    <a href="HdfsServlet?flag=manage"> 全部文件  | MR-日志分析</a>
            ...
            <table id="center_table">
                <c:forEach var="f" items="${hdfsFileList}">
                    <tr>
                        ...
                        <td >
                            <div>
                                <a href="javascript:sort('${f.path }')"><img src="images/a.png" title="分析"  />分析</a>
                            </div>
                        </td>
                        <td>${f.len}</td>
