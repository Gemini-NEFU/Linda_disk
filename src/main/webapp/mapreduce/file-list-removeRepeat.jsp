...
<head>
    ...
    <script>
        ...
        function removerepeat(filePath){
            var encodePath=encodeURI(filePath);
            // alert(encodePath);
            window.location.href="mapreduce/remove-repeat-result.jsp?filePath="+encodePath;
...
<div class="frame-center">
    ...
    <div class="frame-title">
        	   <span>
	        	    <a href="HdfsServlet?flag=manage"> 全部文件  |  MR-去重复</a>
            ...
            <table id="center_table">
                <c:forEach var="f" items="${hdfsFileList}">
                    <tr>
                        ...
                        <td >
                            <div>
                                <a href="javascript:removerepeat('${f.path }')"><img src="images/a.png" title="单词去重复"  />单词去重复</a>
                            </div>
                        </td>
                        <td>${f.len}</td>
